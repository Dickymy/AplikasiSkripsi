                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <form method="POST" action="{{ route('rule-base.destroy', $rule) }}" class="inline">
                                    @csrf @method('DELETE')
                                    <button type="button" onclick="confirmDelete(this.closest('form'), 'rule ini')" class="p-1.5 rounded-lg border border-slate-200 bg-white text-slate-500 hover:text-rose-600 hover:bg-rose-50 hover:border-rose-200 transition-colors">
